import { faGears, faUserTie } from '@fortawesome/free-solid-svg-icons'
...
export default function Page() {
  return (
    <div className='min-h-screen flex flex-col justify-center items-center bg-slate-200 text-slate-800 background-theme-base'>
      ...
      <div className='p-5 md:p-7 bg-slate-800 text-slate-300 rounded-xl shadow-md shadow-purple-800 flex flex-col justiy-center items-center border-2 border-purple-800'>
