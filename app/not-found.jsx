...
export default function NotFound() {
  return (
    <div className='min-h-screen w-full flex flex-col justify-center items-center bg-slate-200'>
        ...
        <Link href="/dashboard" className="my-2 px-3 py-2 border-4 border-slate-700 text-slate-700 hover:bg-slate-700 hover:text-slate-200 text-md font-bold transition-all duration-300 ease">
