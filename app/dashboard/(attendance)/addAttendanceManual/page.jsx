"use client"
import { addAttendanceManulAPI, getEmployeeMinFieldsAPI } from '@/lib/api';
...
export default function AddAttendanceManual() {
  ...
  async function handleSubmit(e, employeeId) {
    ...
    console.log(data);
    const response = await addAttendanceManulAPI(data);
  ...
  return (
    <div className='flex flex-col gap-x-1.5 gap-y-5 md:gap-x-4 md:gap-y-10 text-slate-800 md:py-12 md:px-12 w-full md:w-10/12 mx-auto'>
      ...
      <div>
        <h6 className='mb-2 text-slate-700'>Add Attendance Manual</h6>
