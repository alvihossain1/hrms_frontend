...
export async function getDepartmentChartAPI() {
    return await axios({
        method: 'get',
        url: `${SERVER_URL}/user/department/charts`,
    }).then((response) => {
        return response.data
    })
        .catch((error) => {
...
export async function getPositionChartAPI() {
    return await axios({
        method: 'get',
        url: `${SERVER_URL}/user/position/charts`,
    }).then((response) => {
        return response.data
    })
        .catch((error) => {
...
export async function removeHREmployeeAPI(data) {
    return await axios({
        method: 'delete',
        url: `${SERVER_URL}/admin/hrUser`,
        data: data,
